...
export default class NewBill {
  ...
  handleChangeFile = (e) => {
    ...
    const extensionsAllowed = ["jpg", "jpeg", "png", "PNG"];

    //Retrieve file extension
    const selectedFileCurrentExtension = file.name.split(".").pop();
    console.log(selectedFileCurrentExtension);

    //Delete error-message if present
    ...
    if (extensionsAllowed.includes(selectedFileCurrentExtension)) {
      ...
      //delete attached file if it's not the right format
      ...
      this.document
        ...
        .insertAdjacentHTML(
          "afterEnd",
          "<span class = 'error-message' style='color:red' > Veuillez sélectionnez un fichier au format <em>.jpg, .jpeg </em> ou <em>.png </em></span>"
        );
    }
  };
